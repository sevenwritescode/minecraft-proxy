...
function startMinecraftFriendlyServer() {
  ...
  mcServer.on('login', (client) => {
    ...
    client.end('disconnect',{ message:  JSON.stringify({ text: `Server is starting for authorized player ${username}. Please reconnect in ~45s.`})});
  });
